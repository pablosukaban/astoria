...
const SingleCarPage = () => {
  ...
  return (
    <main className="">
      <SubHero imageLink={imageLink} mainText={'123'} />
        ...
        <div className="mx-auto max-w-7xl space-y-8  px-6 py-16 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-x-6 gap-y-4 md:flex-row md:items-start  md:justify-between">
            <div className="md:flex-1">
              <h1 className="mb-2 flex flex-wrap justify-between text-xl font-bold md:mb-4 lg:text-2xl">
                <span>{/* {title}, {car.year_of_manufacture} */}</span>
          ...
          <div>
            ...
            <p className="lg:text-xl">
              ...
              reiciendis repellendus laborum tempore nemo impedit eligendi
              voluptates. Nobis reiciendis veniam nostrum at ab dignissimos
              aliquam quod facere consequuntur doloribus.
            </p>
          </div>
          <div>
